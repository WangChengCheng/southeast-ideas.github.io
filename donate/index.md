...
<img src="{{ '/styles/images/zhifubao.PNG' | prepend: site.baseurl }}" alt="支付宝二维码付款给Michael Wang" width="310" />
...
![微信二维码付款给Michael Wang]({{ '/styles/images/weixin.png' | prepend: site.baseurl }})
